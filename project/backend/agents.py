...
def validar_imagen(img_bytes: bytes, mime_type: str, nombre: str) -> dict:
    ...
    sys = (
        ...
        "Verifica en la imagen: presencia y color correcto del logo (sol/isotipo amarillo "
        f"institucional {criterios.BRANDING['amarillo']}), uso del verde Mibanco "
        f"{criterios.BRANDING['verde']} y del amarillo {criterios.BRANDING['amarillo']}, "
        "que no haya verdes/amarillos fuera de paleta, proporciones correctas, logo sin "
        "distorsión, legibilidad y alineación con la identidad de marca. "
        "No corrijas la imagen, solo evalúa. En 'observaciones' describe cada incumplimiento "
        "de forma concreta y en 'sugerencias' la acción de diseño recomendada. "
